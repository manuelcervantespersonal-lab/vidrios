      ...
      <section className="section-py bg-background">
        <div className="container-px mx-auto grid max-w-7xl grid-cols-1 gap-16 lg:grid-cols-5">
          <Reveal className="lg:col-span-3">
            ...
            <p className="mt-3 font-body text-sm normal-case tracking-normal text-white/55">
          ...
          <Reveal delay={0.1} className="lg:col-span-2">
            <div className="space-y-6 border border-white/10 bg-secondary p-8">
              <div className="flex gap-3">
                <MapPin className="mt-0.5 h-5 w-5 shrink-0 text-accent" />
                <div>
                  <p className="font-heading text-xs uppercase tracking-widest text-white/40">
                    Oficinas
                  </p>
                  <p className="mt-1 text-sm text-white">{contactInfo.address}</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <a href={contactInfo.phoneHref} className="mt-1 block text-sm text-white hover:text-accent">
                    {contactInfo.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-white">{contactInfo.hours}</p>
                </div>
              </div>
            </div>

            <div className="mt-6 aspect-[4/3] w-full overflow-hidden border border-white/10">
              <iframe
