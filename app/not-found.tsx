...
export default function NotFound() {
  return (
    <section className="flex min-h-[70vh] flex-col items-center justify-center bg-white px-6 text-center">
      ...
      <h1 className="mt-4 text-2xl font-semibold text-primary md:text-3xl">
        Página no encontrada
      </h1>
      <p className="mt-3 max-w-md font-body text-sm normal-case tracking-normal text-muted-foreground">
